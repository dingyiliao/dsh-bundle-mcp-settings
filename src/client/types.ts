...
export type LocaleKey =
  | 'tab' | 'title' | 'description' | 'add' | 'empty' | 'unavailable' | 'readOnly'
  | 'disabled' | 'edit' | 'delete' | 'deleteTitle' | 'deleteDescription' | 'deleting'
  | 'close' | 'cancel' | 'name' | 'namePlaceholder' | 'enabled' | 'transport' | 'stdio'
  | 'http' | 'command' | 'args' | 'argsPlaceholder' | 'cwd' | 'optional' | 'env' | 'url'
  | 'headers' | 'pairsPlaceholder' | 'secretHint' | 'invalid' | 'save' | 'saving'
